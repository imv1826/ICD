function filterSessions() {
    ...
    $('#icd_purchasedsession').closest('tr').hide();

    var emailValue = $('#icd_email').val();
    //const $tableBody = $("[data-name='ConferenceSessionSection'] tbody");
   ...
   filteredSessions.sort((a, b) => {
    ...
    const purchasedConferenceSession = JSON.parse($('#icd_purchasedsession').val() || '[]');
